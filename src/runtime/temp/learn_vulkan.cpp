...
RenderResourceManager ResourceLoader;
...
{
    auto texture = ResourceLoader.LoadTexture("D:/Works/YR/ProxyRP/src/temp/viking_room.png");
    
    mip_levels = texture->MipLevels;

    vk::DeviceSize image_size = VulkanUtil::GetTextureSize(texture->Width, texture->Height, texture->Format);
