...
if(NOT TARGET shader_conductor)
    ...
    if (COMPILE_SHADER_CONDUCTOR)
        ExternalProject_Add(ShaderConductor
            ...
            -DCMAKE_INSTALL_PREFIX=${THIRD_PARTY_DIR}/ShaderConductor/build
    ...
    set(SHADER_CONDUCTOR_BIN_DIR ${THIRD_PARTY_DIR}/ShaderConductor/build/Bin/Release CACHE STRING "")
    if (CMAKE_HOST_WIN32)
